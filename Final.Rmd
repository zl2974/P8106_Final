...
# Introduction
  ...
  One of many important manners is screening, \textit{American Heart Association}\cite{AHA} lists important screening to help monitor heart condition, which is shown below;
\begin{itemize}
\item Blood Pressure
